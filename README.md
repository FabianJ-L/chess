...
- ♟️ **Core Piece Logic**: Encapsulated rules for chess pieces and board interaction.
- 🧪 **Test-Ready**: Includes a dedicated project for unit testing game states.
- 🖥️ **Console Interface**: Basic entry point for running the game locally.
...
## 📄 License
This project is currently unlicensed. Please refer to the repository owner for usage permissions.

---
*Built with passion for Chess and C#.* | [Repository URL](https://github.com/FabianJ-L/chess)
